                    ...
                    try {
                        ...
                        if (content.has("cnt_id")) {
                            ...
                            if ("nlp".equals(sub)) {
                                ...
                                JSONArray dataArray = dataResult.getJSONArray("result");
                                JSONObject array0 = dataArray.getJSONObject(0);
                                String voiceCity = array0.getString("city");
                                mNlpText.setText("");
                                mNlpText.append(voiceCity);
                                Intent intent = new Intent();
                                intent.putExtra("name",voiceCity);
                                setResult(1,intent);
                                Log.i( TAG, resultStr );
                                finish();
                            }
